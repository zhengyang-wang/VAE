...
flags.DEFINE_integer('validation_interval', 100, 'number of iterations for validation')
flags.DEFINE_integer('save_interval', 500, 'number of iterations for saving')
flags.DEFINE_integer("updates_per_epoch", 1000, "number of updates per epoch")
flags.DEFINE_integer('summary_step', 100, 'number of steps to save the summary')
...
flags.DEFINE_float('one_over_sigma', 1.0, 'hyperparameter 1/sigma')
